...
// A reusable component to generate star rating HTML.
const StarRating = ({ rating = 0, count = 0 }) => {
    const fullStars = Math.round(rating);
    const emptyStars = 5 - fullStars;
    let starsHtml = '<div class="flex items-center my-1">';
    ...
    starsHtml += `<span class="text-xs text-gray-600 ml-2">(${count} reviews)</span></div>`;
    return starsHtml;
};
